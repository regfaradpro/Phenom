...
public class Add extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //       toolbar_1.setTitle(j);
            ...
            if(bundle.get("filename")!=null){
               // Toast.makeText(this,(String)bundle.get("filename"),Toast.LENGTH_LONG).show();
                changeImageView();
            }
        }
 ...
 //       ImageView image_challenge = (ImageView) findViewById(R.id.challengePic);
 //       image_challenge.setImageURI(Uri.parse((String) bundle.get("filepath")));
  /*      image_challenge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                addPhoto();
            }
    ...
    public void changeImageView(){
        ...
        if(bundle!=null)
        {
            ...
            ImageView image = (ImageView) findViewById(R.id.challengePic);
    ...
    public void addChallenge(){
        ...
        ImageView image = (ImageView) findViewById(R.id.challenge_image);
